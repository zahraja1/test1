...
@section('title', 'Form Update company')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Form Update company</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <form action="{{ route('edit.company', $company->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" value="{{ old('name', $company->name) }}">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="website" class="form-control @error('website') is-invalid @enderror" id="website" value="{{ old('website', $company->website) }}">
                                @error('website')
                                <div class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </div>
